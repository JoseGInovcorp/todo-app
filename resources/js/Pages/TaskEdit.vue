<template>
    <Layout>
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="due_date"
                                :class="[
                                    'w-full rounded-md border-gray-300 dark:border-gray-500 bg-white dark:bg-gray-50 text-gray-900 dark:text-gray-800 shadow-sm focus:border-indigo-500 focus:ring-indigo-500',
            ...
            <div
                class="mt-6 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md p-4"
            >
                <div class="flex">
